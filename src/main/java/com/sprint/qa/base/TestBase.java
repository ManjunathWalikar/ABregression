...
//    public static HashMap<String, Object> chromepreferences = new HashMap<>();
    ...
    public TestBase() {
        try {
            prop = new Properties();
            if (true) {
                FileInputStream fis = new FileInputStream("src/main/java/com/sprint/qa/config/qa2config.properties");
                prop.load(fis);
...
//        chromeOptions.setExperimentalOption("prefs", chromepreferences);
        ...
        driver.get("https://www.alliancebernstein.com");
        
    }
    
    public static void launchApplicationURL(String country)
    {
    ...
    public void selectDropDown(int i, String Value) throws IOException, InterruptedException {
        ...
        switch (Value) {
            ...
            case "Subs #":
            case "Status":
                selectObject(driver.findElement(By.xpath("//div[@class='row']/div[@class='col-8']//div[@class='row']/div[1]//select"))).selectByVisibleText(Value);
            case "Change Order #":
            case "Change Type":
            case "Order #":
            case "Document #":
    ...
    public void removeDropdown(int i) throws InterruptedException {
        try {
            driver.findElement(By.xpath("//i[@title='Add']")).click();
            Actions act = new Actions(driver);
